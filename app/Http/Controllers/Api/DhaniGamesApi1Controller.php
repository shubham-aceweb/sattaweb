...
class DhaniGamesApi1Controller extends Controller
{
        ...
        if (empty($authKeyEncryted)) {
            ...
            if (!$authokey) {
                ...
                $data = [
                    ...
                    "app_download_link" => "https://www.bestsattamatka.net/download-app/com.bestsattamatka.dhanigames",
