...
class NdrGamesApi1Controller extends Controller
{
        ...
        if (empty($authKeyEncryted)) {
            ...
            if (!$authokey) {
                ...
                $data = [
                    ...
                    "app_download_link" => "https://bestsattamatka.net/download-app/com.bestsattamatka.ndrgames",
