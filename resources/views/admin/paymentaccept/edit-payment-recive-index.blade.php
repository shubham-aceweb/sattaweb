    ...
    <div class="row">
        ...
        <div class="col-lg-12">
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <form method="post" action="{{url('admin/edit_deposit_acc_data')}}/{{$result->id}}" enctype="multipart/form-data">
                        {!! csrf_field() !!}
                        ...
                        <div class="form-group row">
                            <div class="col-4">
                                ...
                                <input type="text" class="form-control" name="type" value="{{$result->type}}" required="required" readonly />
                            </div>
                            <div class="col-4">
                                <label class="col-form-label">Bank Name<span class="text-danger" title="This field is required">*</span></label>
                                <input type="text" class="form-control" name="bank_name" value="{{$result->bank_name}}" required="required" />
                            </div>
                             <div class="col-4">
                                <label class="col-form-label">UPI OR Account Number <span class="text-danger" title="This field is required">*</span></label>
                                <input type="text" class="form-control" name="upi_or_account" value="{{$result->upi_or_account}}" required="required" />
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-6">
                                ...
                                <select name="status" class="form-control">
                                    ...
                                    <option value="Enable" {{ $result->status == 'Enable' ? 'selected' : '' }}>Enable</option>
                                    <option value="Disable" {{ $result->status == 'Disable' ? 'selected' : '' }}>Disable</option> 
                                </select>
                            </div>
