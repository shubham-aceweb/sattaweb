                            ...
                            <div class="col-lg-12">
                                <div class="login-form">
                                    <div class="text-center">
                                        ...
                                        <img src="{{asset('public/assets/img/famousonline.png')}}"  alt="logo" style="width: 100px; height: 100px;">
                                </div>

                                        <h1 class="text1">Agent Login</h1>
                                    </div>
                                    @if($errors->any())
                                    <div class="col-sm-12">
                                    ...
                                    <form class="user" method="POST" action="{{ route('login-request') }}">
                                      @csrf
                                        <div class="form-group">
                                            <input type="text" placeholder="Email/Mobile" id="email" class="form-control" name="email" required autofocus />
                                            @if ($errors->has('email'))
